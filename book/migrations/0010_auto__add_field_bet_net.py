...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bet.net'
        db.add_column(u'book_bet', 'net',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=5, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bet.net'
        db.delete_column(u'book_bet', 'net')
    ...
    models = {
        ...
        u'book.bet': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'net': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '5', 'decimal_places': '2'}),
