...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'book_baseballline', 'gamekey', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'BasketballLine.gamekey'
        db.alter_column(u'book_basketballline', 'gamekey', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

    def backwards(self, orm):

        # Changing field 'BaseballLine.gamekey'
        db.alter_column(u'book_baseballline', 'gamekey', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'BasketballLine.gamekey'
        db.alter_column(u'book_basketballline', 'gamekey', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        u'book.baseballline': {
            ...
            'gamekey': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
